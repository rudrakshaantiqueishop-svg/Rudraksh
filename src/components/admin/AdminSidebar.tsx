  ...
  return (
    <aside className="flex shrink-0 flex-col md:h-full md:w-[260px]">
      ...
      <div className="fixed bottom-4 left-3 right-3 z-50 max-w-xl mx-auto md:static md:z-auto md:w-full md:max-w-none md:mx-0">
        <div className="relative flex items-center rounded-none border border-stone-200/90 bg-white/95 p-1.5 shadow-[0_12px_40px_rgba(0,0,0,0.16)] backdrop-blur-xl md:border-none md:bg-transparent md:p-0 md:shadow-none md:backdrop-blur-none">
