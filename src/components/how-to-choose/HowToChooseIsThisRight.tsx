...
const forYou = [
  "You value authenticity over trends",
  "You want clarity before making a decision",
  "You prefer guidance over guesswork",
  "You respect tradition and intention",
];

const notForYou = [
  "You're looking for instant results or guarantees",
  'You want the "most powerful" stone without context',
  "You prefer impulse buying over understanding",
];
...
export default function HowToChooseIsThisRight() {
  return (
